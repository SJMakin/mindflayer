...
public class Markdown : DependencyObject
{
    ...
    private Inline ImageInlineEvaluator(Match match)
    {
        ...
        {
            return new Run("!" + url) { Foreground = System.Windows.Media.Brushes.Red };
        }

        System.Windows.Controls.Image image = new System.Windows.Controls.Image { Source = imgSource, Tag = linkText };
        ...
        {
            System.Windows.Data.Binding binding = new(nameof(BitmapImage.Width));
            binding.Source = imgSource;
            binding.Mode = BindingMode.OneWay;

            BindingExpressionBase bindingExpression = BindingOperations.SetBinding(image, System.Windows.Controls.Image.WidthProperty, binding);
